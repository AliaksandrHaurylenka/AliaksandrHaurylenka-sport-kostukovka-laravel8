    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($data->avatar)
                        <img class="photo" src="{{ asset(env('UPLOAD_PATH').App\Models\User::PATH.$data->avatar) }}">
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('description', trans('quickadmin.users.fields.description').'*', ['class' => 'control-label']) !!}
