            ...
            <div class="row">
                <div class="col-xs-3 form-group">
                    @if ($data->photo_section_menu)
                        <img class="photo" src="{{ asset(env('UPLOAD_PATH').App\Models\Section::PATH.$data->photo_section_menu) }}">
                    @else
                        <img class="photo" src="{{ asset(env('UPLOAD_PATH').App\Models\Section::PATH.'img-default.jpg') }}"/>
                    @endif
                ...
                <div class="col-xs-3 form-group">
                    @if ($data->photo)
                        <img class="photo" src="{{ asset(env('UPLOAD_PATH').App\Models\Section::PATH.$data->photo) }}">
                    @else
                        <img class="photo" src="{{ asset(env('UPLOAD_PATH').App\Models\Section::PATH.'img-default.jpg') }}"/>
                    @endif
                ...
                <div class="col-xs-3 form-group">
                	@if ($data->photo_sport)
                        <img class="photo" src="{{ asset(env('UPLOAD_PATH').App\Models\Section::PATH.$data->photo_sport) }}">
                    @else
                        <img class="photo" src="{{ asset(env('UPLOAD_PATH').App\Models\Section::PATH.'img-default.jpg') }}"/>
                    @endif
