...
@if(isset($photo_sports, $coaches, $coaches_archive, $prides))
	...
	<section class="mt-5 wow fadeIn">
		...
		<div class="jumbotron text-center hoverable p-0">
			...
			<div class="row">
				<!-- Grid column -->
				<div class="col-sm-4 offset-md-1 m-0">
					<!-- Featured image -->
				...
				<!-- Grid column -->
				<!-- Grid column -->
				<div class="col-sm-7 text-md-left ml-3 mt-1">
						...
						@foreach($coaches_archive as $coach)
							<div class="col-lg-6 mb-2">
								<div class="row">
									...
									<div class="col-sm-8 archive-description-coach">
						...
						@foreach($prides as $men)
							<div class="col-lg-6 mb-2">
								<div class="row">
									...
									<div class="col-sm-8">
										<h6 class="h6-responsive text-uppercase mt-1">{{ $men->name }}</h6>
										{!! $men->description !!}
									</div>
								</div>	
							</div>
