...
<head>
	...
	<style>
		...
		p {color:#333; padding:0 0 0.5em; font:1rem Arial; line-height:150%}
...
<body class="container">
	<div class="layout">
		...
		отношении всей информации, которую сайт <strong>Спорт-Костюковка</strong>, (далее – Сайт Спортивнооздоровительного комплекса) расположенный на 
		доменном имени <strong>https://sport-kostukovka.by</strong> (а также его субдоменах), может получить о Пользователе во время использования 
		сайта https://sport-kostukovka.by (а также его субдоменов), его программ и его продуктов.</p>
		...
		на управление сайтом <strong>Спорт-Костюковка</strong>,
		...
		<p>1.1.5. «Сайт <strong> Спорт-Костюковка</strong>» - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по уникальному 
		адресу (URL): <strong>https://sport-kostukovka.by</strong>, а также его субдоменах.</p>

		<p>1.1.6. «Субдомены»  - это страницы или совокупность страниц, расположенные на доменах третьего уровня, 
		принадлежащие сайту Спорт-Костюковка, а также другие временные страницы, внизу который указана контактная
		информация Администрации</p>
		
		<p>1.1.5. «Пользователь сайта <strong>Спорт-Костюковка</strong> » (далее Пользователь) – лицо, имеющее доступ 
		к сайту <strong>Спорт-Костюковка</strong>, посредством сети Интернет 
		и использующее информацию, материалы и продукты сайта <strong>Спорт-Костюковка</strong>.</p>
		...
		Сайт Спортивнооздоровительного комплекса.</p>
		
		<h2>2. Общие положения</h2>
		<p>2.1. Использование сайта Спорт-Костюковка Пользователем означает согласие с настоящей Политикой 
		...
		сайта Спорт-Костюковка .</p>

		<p>2.3. Настоящая Политика конфиденциальности применяется к сайту Спорт-Костюковка.
		Сайт Спортивнооздоровительного комплекса не контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь 
		может перейти по ссылкам, доступным на сайте Спорт-Костюковка.</p>
		...
		регистрации на сайте Спорт-Костюковка или при подписке на информационную e-mail рассылку.</p>
		
		<p>3.2. Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности, предоставляются 
		Пользователем путём заполнения форм на сайте Спорт-Костюковка и включают в себя следующую информацию:<br />
		...
		<p>3.3. Сайт Спортивнооздоровительного комплекса защищает Данные, которые автоматически передаются при посещении страниц:<br />
		- IP адрес;<br />
		...
		<p>3.3.1. Отключение cookies может повлечь невозможность доступа к частям сайта <?php echo 'Спорт-Костюковка' ?>, требующим 
		авторизации.</p>

		<p>3.3.2. Сайт Спортивнооздоровительного комплекса осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация 
		...
		4.1.1. Идентификации Пользователя, зарегистрированного на сайте Спорт-Костюковка для его дальнейшей авторизации.<br />

		4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта Спорт-Костюковка.<br />

		4.1.3. Установления с Пользователем обратной связи, включая направление уведомлений, запросов, касающихся использования 
		сайта Спорт-Костюковка, обработки запросов и заявок от Пользователя.<br />

		4.1.4. Определения места нахождения Пользователя для обеспечения безопасности, предотвращения мошенничества.<br />

		4.1.5. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.<br />

		4.1.6. Создания учетной записи для использования частей сайта Спорт-Костюковка, если Пользователь дал согласие на 
		...
		Федерации только по основаниям и в порядке, установленным законодательством Республики Беларусь.</p>
		...
		сайта Спорт-Костюковка, и давать согласие на их обработку.</p>
		...
		Республики Беларусь, за исключением случаев, предусмотренных п.п. 5.2. и 7.2. настоящей Политики Конфиденциальности.</p>
		...
		тексты и т. д.), к которой он может иметь доступ как к части сайта Спорт-Костюковка, несет лицо, предоставившее 
		такую информацию.</p>
		
		<p>7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта Спорт-Костюковка, может 
		являться объектом интеллектуальной собственности, права на который защищены и принадлежат другим Пользователям, 
		партнерам или рекламодателям, которые размещают такую информацию на сайте Спорт-Костюковка. <br />
		...
		сайте Спорт-Костюковка) допускается их распространение при условии, что будет дана ссылка 
		на Сайт Спортивнооздоровительного комплекса.</p>
		...
		содержащихся на сайте Спорт-Костюковка или передаваемых через него.</p>
		...
		сайте Спорт-Костюковка, включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого 
		...
		<p>8.3. При не достижении соглашения спор будет передан на рассмотрение Арбитражного суда г. Гомель.</p>
		...
		<p>9.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте Спорт-Костюковка, если 
		...
		адресу: sendmail.haurylenka@gmail.com</p>
		
		<p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу http://https://sport-kostukovka.by/politika.ht
	</div>
</body>
</html>