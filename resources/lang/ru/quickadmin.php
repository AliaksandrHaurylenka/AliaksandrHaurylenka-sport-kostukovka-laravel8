...
return [
    ...
    'main' => [
        ...
        'fields' => [
            'photo' => 'Фото',
            'description' => 'Описание',
            'block' => 'Блок (слайд, сооружения)',
            'class' => 'Дабавить класс css "active"',
            'position' => 'Позиция слайда в % от верха',
            'for_indicators' => '№ слайда',
        ],
    ],

    'history' => [
        'title' => 'Во вкладке "История"',
        'fields' => [
            'title' => 'Название',
            'photo' => 'Слайд',
            'description' => 'Описание',
    ...
    'service' => [
        ...
        'fields' => [
            'service' => 'Услуга',
            'price' => 'Стоимость',
            'price-the-evening' => 'Вечернее время',
            'price-5-lessons' => '5 занятий',
            'price-10-lessons' => '10 занятий',
            'price-other' => 'Дополнительные услуги',
        ],
    ],
    ...
    'coach' => [
        ...
        'fields' => [
            ...
            'photo' => 'Фото',
            'description' => 'Описание',
            'sport-section' => 'Вид спорта',
            'work' => 'Работает в данное время?',
        ],
    ],
    ...
    'section' => [
        ...
        'fields' => [
            'title' => 'Название',
            'photo_section_menu' => 'Изображение меню',
            'photo' => 'Общее фото',
            'description' => 'Описание',
            'description_main_page' => 'Описание фото на Главной',
            'photo_sport' => 'Фото спорта',
        ],
    ],
	...
	'subscribe' => [
		...
		'fields' => [
			...
			'updated_at' => 'Дата подтверждения подписки',
		],
	],

	'gomelglass' => [
		'title' => 'ОАО "Гомельстекло"',
		'fields' => [
			'id' => "Id",
			'photo' => 'Фото',
			'description' => 'Описание',
	...
	'quickadmin_title' => 'Спорт-Костюковка',
];
