...
MAIL_FROM_NAME = 'Спорт-Костюковка', // от какого имени будет отправляться письмо
MAIL_SUBJECT = 'Сообщение с формы обратной связи', // тема письма
MAIL_ADDRESS = 'goric0312@mail.ru, aliaksandr.haurylenka@gmail.com', // кому необходимо отправить письмо
...
MAIL_SMTP_HOST = 'smtp.mailtrap.io', // SMTP-хост
MAIL_SMTP_PORT = '2525', // SMTP-порт
MAIL_SMTP_USERNAME = 'd47437d27d54e1', // SMTP-пользователь
MAIL_SMTP_PASSWORD = '520a54484aa749'; // SMTP-пароль
//MAIL_SMTP_HOST = 'smtp.gmail.com', // SMTP-хост
//MAIL_SMTP_PORT = '587', // SMTP-порт
//MAIL_SMTP_USERNAME = 'sendmail.haurylenka@gmail.com', // SMTP-пользователь
//MAIL_SMTP_PASSWORD = '9Rf-Nzu-BiW-YAJ'; // SMTP-пароль
